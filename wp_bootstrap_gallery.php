...
function wp_bootstrap_gallery( $content, $attr ) {
	...
	$output		=	"<ul id='$selector' class='thumbnails row'>";
	...
	foreach ( $attachments as $id => $attachment ) {
		...
		$output .= "<li class='item span" . $span_array[$attachment_count] . "'>";
...
function wp_bootstrap_gallery_add_attachment_class($html){
    ...
    $html = str_replace('<a','<a class="thumbnail fancybox" rel="group"',$html);
